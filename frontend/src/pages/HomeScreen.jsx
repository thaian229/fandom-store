...
import { AppstoreOutlined, MailOutlined, SettingOutlined, EditOutlined, DeleteOutlined, ShoppingCartOutlined, EyeOutlined, ExclamationCircleOutlined } from '@ant-design/icons';
import { Skeleton, Card, Row, Col, Avatar, Modal, Button, Statistic, Menu, PageHeader, Carousel } from "antd";
                        ...
                        >
                            ...
                            >
                                <Menu.ItemGroup key="g1" title="Official Releases">
                                    ...
                                    <Menu.Item key="2">Merchandises</Menu.Item>
                                    <Menu.Item key="3">Concerts</Menu.Item>
                                </Menu.ItemGroup>
                                <Menu.ItemGroup key="g2" title="Fansite Goods">

                                    <Menu.Item key="4">Keyrings</Menu.Item>
                                    <Menu.Item key="5">Artbooks</Menu.Item>
                                    <Menu.Item key="6">Photocards</Menu.Item>
                                    <Menu.Item key="7">Postcards</Menu.Item>
                                    <Menu.Item key="8">Slogans</Menu.Item>
                                </Menu.ItemGroup>
                            </SubMenu>
                            <SubMenu
                                key="sub2"
