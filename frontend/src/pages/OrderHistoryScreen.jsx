    ...
    render() {
        return (
            <div style={{
                ...
                <Row align="center" style={{ width: "100vw" }}>
                    <Col span={16} align='middle' style={{ backgroundColor: "white", paddingTop: "50px", paddingBottom: "90px", marginTop: "60px", borderRadius: "10px" }}>
                        <Row align='center'>
                            <Col span={24}>
                                <Title level={2} style={{marginBottom: "30px"}} >Here are your orders:</Title>
                            </Col>
                            <Col span={20}>
                            ...
                            <Col span={4}>
                                ...
                                {this.state.orderList.map((item, index) => {
                                    return (
                                        <Row key={item.order_id} style={{ borderWidth: "2px", borderStyle: "solid", borderColor: "#f2f2f2", border: "none", width: "100%", marginTop:"30px" }}>
                                            <Col span={24}>
